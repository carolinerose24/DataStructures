...
//  DataStructures
//
//  Created by Jarman, Caroline on 2/21/19.
...
#include "/Users/cjar7174/Documents/C++ Folder/DataStructures/DataStructures/Model/Nodes/DoubleNode.h"
...
public:
    CircularList();
    ~CirculatList(); //needs a destructor, unlike double node
    ...
    int getSize() const;
    //no get front/end->would return the same thing
};
...
DoubleNode<Type> * CircularList<Type> :: findNode(int index)
{
    ...
    if (index < this->size / 2) //to see where it is
    {
...
void CircularList<Type> :: add(Type item)
{
    ...
    {
        addedNode = ned DoubleNode<Type>(item, this->end, this->front);
